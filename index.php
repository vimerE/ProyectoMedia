...
$url = "http://localhost/proyectoPersonal/index.php";
// Extraer la ruta
...
<html lang="es">
  <head>
    ...
    <title><?php echo NAME_APP; ?> - Portada</title>
...
<body>
    <?php
      echo $objClassTemplates->contenedorCarga(); // funciona con el script de abajo
    ...
    <section class="container">
      ...
      <div class="row">
        <?php 
        echo $objClassTemplates->articulosUno_row8(); 
    ...
    <!--Este script funciona con lo que retorna $objClassTemplates->contenedorCarga() -->
    <script>
