...
$url = "http://localhost/proyectoPersonal/administracion/editar-articulo.php";
// Extraer la ruta
...
switch($nombreArchivo){
  ...
  case 'editar-articulo': $nombreArchivo = "Editar artículo"; break;
...
<html lang="es">
  <head>
    ...
    <title><?php echo NAME_APP; ?> - Editar artículo</title>
...
<body>
    ...
    <section class="container">
      ...
      <div class="row">
        <?php 
        echo $objClassTemplatesAdministracion->sectionEditarAdministracion_row8($id, $categoria, $titulo); 
