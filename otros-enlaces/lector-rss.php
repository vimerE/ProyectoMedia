...
$url = "http://localhost/proyectoPersonal/lector-rss.php";
// Extraer la ruta
...
<html lang="es">
  <head>
    ...
    <title><?php echo NAME_APP; ?> - Lector RSS</title>
...
<body>
    ...
    <section class="container">
      ...
      <div class="row">
        <?php 
        echo $objClassTemplatesOtrosEnlaces->sectionOtrosEnlaces_row8($nombreArchivo); // funciona con el script de abajo
    ...
    <!--Este script funciona con lo que retorna $objClassTemplatesOtrosEnlaces->sectionOtrosEnlaces_row8($nombreArchivo) -->
    <script>
        function copiarEnlace1(){
            var input = document.getElementById("politica"); // Obtener el campo de entrada
            input.select(); // Seleccionar el texto en el campo de entrada
            document.execCommand("copy"); // Copiar el texto seleccionado al portapapeles del sistema
            // Opcional: Cambiar el texto del botón después de copiar
            var button = document.getElementById("btnPolitica");
            button.innerHTML = '<i class="fa-solid fa-check"></i> ¡Copiado!';
            setTimeout(function(){button.innerHTML = '<i class="fa-solid fa-copy"></i> Copiar'}, 5000);
        }

        function copiarEnlace2(){
            var input = document.getElementById("economia"); // Obtener el campo de entrada
            input.select(); // Seleccionar el texto en el campo de entrada
            document.execCommand("copy"); // Copiar el texto seleccionado al portapapeles del sistema
            // Opcional: Cambiar el texto del botón después de copiar
            var button = document.getElementById("btnEconomia");
            button.innerHTML = '<i class="fa-solid fa-check"></i> ¡Copiado!';
            setTimeout(function(){button.innerHTML = '<i class="fa-solid fa-copy"></i> Copiar'}, 5000);
        }

        function copiarEnlace3(){
            var input = document.getElementById("ciencia"); // Obtener el campo de entrada
            input.select(); // Seleccionar el texto en el campo de entrada
            document.execCommand("copy"); // Copiar el texto seleccionado al portapapeles del sistema
            // Opcional: Cambiar el texto del botón después de copiar
            var button = document.getElementById("btnCiencia");
            button.innerHTML = '<i class="fa-solid fa-check"></i> ¡Copiado!';
            setTimeout(function(){button.innerHTML = '<i class="fa-solid fa-copy"></i> Copiar'}, 5000);
        }

        function copiarEnlace4(){
            var input = document.getElementById("cultura"); // Obtener el campo de entrada
            input.select(); // Seleccionar el texto en el campo de entrada
            document.execCommand("copy"); // Copiar el texto seleccionado al portapapeles del sistema
            // Opcional: Cambiar el texto del botón después de copiar
            var button = document.getElementById("btnCultura");
            button.innerHTML = '<i class="fa-solid fa-check"></i> ¡Copiado!';
            setTimeout(function(){button.innerHTML = '<i class="fa-solid fa-copy"></i> Copiar'}, 5000);
        }

        function copiarEnlace5(){
            var input = document.getElementById("tecnologia"); // Obtener el campo de entrada
            input.select(); // Seleccionar el texto en el campo de entrada
            document.execCommand("copy"); // Copiar el texto seleccionado al portapapeles del sistema
            // Opcional: Cambiar el texto del botón después de copiar
            var button = document.getElementById("btnTecnologia");
            button.innerHTML = '<i class="fa-solid fa-check"></i> ¡Copiado!';
            setTimeout(function(){button.innerHTML = '<i class="fa-solid fa-copy"></i> Copiar'}, 5000);
        }
    </script>
