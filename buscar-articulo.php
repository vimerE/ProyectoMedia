...
$articulo = $_GET["articulo"]; // Título del artículo para hacer la búsqueda
...
$url = "http://localhost/proyectoPersonal/buscar-articulo.php";
// Extraer la ruta
...
<html lang="es">
  <head>
    ...
    <title><?php echo NAME_APP; ?> - Buscar publicación</title>
...
<body>
    ...
    <section class="container">
      ...
      <div class="row">
        <?php 
        echo $objClassTemplates->resultadosBusqueda_row8($articulo); 
